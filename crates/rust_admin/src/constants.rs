...
pub(crate) const CATALOG_SCHEMA_VERSION: i32 = 2;
pub(crate) const CATALOG_CONTENT_TYPE: &str = "application/vnd.autonomi.video.catalog+json;v=2";
...
pub const JOB_KIND_PUBLISH_CATALOG: &str = "publish_catalog";
